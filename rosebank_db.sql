...
('Blue', 33, 'fail', 'FD745', 'Fashion and Design', 'Zolelwa', 'Nosipho', 2)
('Pink', 22, 'Pass', 'IoT112', 'Big_data', 'Brigdestone', 'MR Hang_on', 1)
('Magenta', 29, 'fail', 'DS504', 'Data science', 'Ketro Sithole', 'MR Dlamini', 1)
('Respect', 40, 'Pass', 'DS911', 'Data Capturing', 'DR. Trompie', 'Dr. Sithole', 1)
;
